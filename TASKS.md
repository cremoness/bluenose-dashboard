...
> Última actualización: 2026-04-27 | Limpieza: tareas desde 30 de marzo

---

## 🔴 URGENTE / Hoy mismo

- [x] **[WV PE]** Cristian + Marcos: investigar y eliminar pagos duplicados en archivo TXT de Débito BCP — RESUELTO: validado HubSpot y sistema de pagos, no se encontraron duplicados en ambas quincenas. Se agregaron validaciones en WFs de creación de pagos para evitar duplicación futura | Owner: Cristian + Marcos
...
- [ ] 🆕 **[UPSJB]** Estuardo: reunirse con logística para gestionar cotizaciones urgentes de IA/WhatsApp con al menos 2 proveedores — requerimiento de auditoría SUNAT | Owner: Estuardo (cliente)
- [ ] 🆕 **[UPSJB]** Estuardo + Diego: actualizar cuadro de inversión con tasas de conversión del intake 26.1 castigadas y compartir en Discord hoy | Owner: Estuardo + Diego (cliente)
- [ ] 🆕 **[UPSJB]** Diego: enviar correo a agencia SEO (con Pablo en copia) para analizar posicionamiento de landings y confirmar alta en Google Search Console | Owner: Diego (cliente)
- [ ] 🆕 **[WV PE]** Cristian: 23Abril — corregir automatización de cobros duplicados en archivo TXT — Rodrigo Benites detectó que los duplicados corresponden a negocios de segunda quincena; mañana es el último día de plazo para enviar a proceso de cobro | Owner: Cristian
- [ ] 🆕 **[UCSP — Centro de Idiomas]** Ángel: 23Abril — asistir al 2do focus group de hoy | Owner: Ángelito
- [ ] 🆕 **[WV HND]** Cristian + Ángel: 23Abril — conciliar horas consumidas de WV Honduras de marzo y febrero por país usando reporte Excel (no automatizado) — pasar info a Patty urgente para emitir informe correcto y poder facturar | Owner: Cristian + Ángelito
- [ ] 🆕 **[WV EC]** Cristian: 23Abril — revisar caso donante BP con 3 cobros generados — Valeria Yanza reportó reclamo formal, HubSpot no identificó el duplicado | Owner: Cristian
...
#### Indicadores e Integración Web
- [ ] 🆕 **[WV HND]** Luis Gustavo: 23Abril — definir indicadores clave para piloto de integración (horas reducidas, niños alcanzados, personas beneficiadas en Cultivando Futuros y Wash) y enviar al equipo técnico | Owner: Luis Gustavo
- [ ] 🆕 **[WV HND]** Luis Gustavo: 23Abril — revisar y enviar plantillas de WhatsApp corregidas antes del jueves para actualizar workflows — variables corregidas a formato "first name" todo junto y en minúsculas | Owner: Luis Gustavo
- [ ] 🆕 **[WV HND]** Luis Gustavo: 23Abril — coordinar sesión con Eric para revisión técnica de APIs e indicadores de integración | Owner: Luis Gustavo
- [ ] 🆕 **[WV HND]** Luis Gustavo: 23Abril — incluir plan de medios en hoja de ruta compartida para seguimiento en HubSpot | Owner: Luis Gustavo
- [ ] 🆕 **[WV HND]** Luis Gustavo: 23Abril — enviar recordatorio a Esperfago por pendientes de variables transaccionales | Owner: Luis Gustavo
- [ ] 🆕 **[WV HND]** Erick: 23Abril — compartir APIs configuradas por proyecto y realizar sesión para explicar campos, fórmulas y disponibilidad de indicadores para la prueba piloto | Owner: Erick (cliente)
- [ ] 🆕 **[WV HND]** Marcos: 23Abril — confirmar activación de plantillas WhatsApp corregidas y avisar al equipo cuando estén listas para los workflows | Owner: Marcos
- [ ] 🆕 **[WV HND]** Comunicaciones BN: 23Abril — coordinar armado de workflow de Cultivando Futuros cuando estén activas las plantillas y coordinar próxima reunión de KPIs con Luis para optimizar CPL y tasa de conversión | Owner: Comunicaciones BN
...
#### Contrato y Licencias HubSpot
- [ ] 🆕 **[WV ES]** Pablo: 23Abril — revisar checklist del contrato HubSpot y preparar escenarios para negociar actualización con Internacional — Operations + reducción de contactos de 120k a 80-90k | Owner: Pablo
- [ ] 🆕 **[WV ES]** Pablo: 23Abril — enviar propuesta de esquema de licencias y costes HubSpot para iniciar conversaciones con Internacional | Owner: Pablo
- [ ] 🆕 **[WV ES]** Isa: 23Abril — coordinar con Pablo para definir requerimientos concretos de HubSpot antes de negociar con Internacional | Owner: Isa (cliente)

#### Migración y Soporte Internacional
- [ ] 🆕 **[WV ES]** Pablo: 23Abril — escribir a Jorge para desbloquear migración de base de datos y gestionar horarios o recursos necesarios | Owner: Pablo
- [ ] 🆕 **[WV ES]** Isa: 23Abril — contactar a Roberto Barsayo (jefe de Jorge) para gestionar soporte técnico y recursos para migración | Owner: Isa (cliente)
- [ ] 🆕 **[WV ES]** Isa: 23Abril — enviar comunicación a dirección de Italia solicitando apoyo o recursos conforme a necesidades detectadas | Owner: Isa (cliente)
- [ ] 🆕 **[WV ES]** Mario Gómez: 23Abril — reenviar informes a Pablo y Sofía para armar reportes consolidados y mejorar visibilidad de datos clave | Owner: Mario Gómez (cliente)
- [ ] 🆕 **[WV ES]** Esther: 23Abril — solicitar a Sofía templates para subida de altas y gestionar liberación de correos en cuarentena | Owner: Esther (cliente)
- [ ] 🆕 **[WV ES]** Jesús: 23Abril — gestionar con agencia obtención del archivo histórico de pedidos para actualizar HubSpot | Owner: Jesús (cliente)
- [ ] 🆕 **[WV ES]** Jesús: 23Abril — confirmar invitación al sandbox con equipo para completar migración y actualización | Owner: Jesús (cliente)

#### Workflows de Bienvenida
- [ ] 🆕 **[WV ES]** Pablo: 23Abril — asistir a Esther para configurar workflows de llamada de bienvenida con propiedad personalizada "llamada de bienvenida" (Sí/No) en HubSpot | Owner: Pablo
- [ ] 🆕 **[WV ES]** Esther: 23Abril — preparar diseño de emails y bases de datos para automatización de bienvenida y coordinar con Pablo para implementación | Owner: Esther (cliente)
...
- [ ] 🆕 **[WV CL]** Cristian: 23Abril — revisar archivo de importación de pagos enviado por Marcos (aceptados y rechazados desde 1 dic 2025) — confirmar columnas de la pestaña "Importar" | Owner: Cristian
- [ ] 🆕 **[WV CL]** Equipo: 23Abril — investigar compromisos de Brasil detectados en la base de WV Chile al revisar pagos mensuales por método de pago | Owner: Equipo
...
#### Performance canal web
- [ ] 🆕 **[WV CL]** Cristian + Pablo: crear panel de visualización de performance de conversiones por canal web — cliente envió lista de variables a activar | Owner: Cristian + Pablo

#### Plataforma Rendiciones (Más Recursos)
- [ ] 🆕 **[WV CL]** Marcos: validar con muestra de pagos del archivo si el cliente los creó sin ID de pago — si no los hay, importar y agregar propiedad adicional para ubicarlos fácilmente en caso de ajuste; actualizar documento | Owner: Marcos
- [ ] 🆕 **[WV CL]** Pablo: investigar y solucionar sincronización de root con VirtualPost — root no aparece en vista de la agencia aunque sí en módulo administrativo; importar datos desde API para evitar pérdidas | Owner: Pablo
- [ ] 🆕 **[WV CL]** Pablo: actualizar buscador de la plataforma para mostrar root como campo visible en interfaz — evitar confusión con correos de captadores y mejorar precisión en búsqueda | Owner: Pablo
- [ ] 🆕 **[WV CL]** Gonzalo: formalizar con Francisco el plazo de baja automática para socios morosos — evaluar si 90 o 120 días (3-4 ciclos sin pago) es el tiempo adecuado para mantener base limpia | Owner: Gonzalo (cliente)
- [ ] 🆕 **[WV CL]** Gonzalo + Diana: revisar caso de apellido cambiado inesperadamente en CRM por normalizador externo (Bambe) — corregir configuración para evitar discrepancias en datos | Owner: Gonzalo (cliente) + Diana (cliente)
- [ ] 🆕 **[WV CL]** Francisco: enviar resumen de observaciones y pruebas de la plataforma por correo a todos los participantes | Owner: Francisco (cliente)
...
- [ ] 🆕 **[WV EC]** Valeria Yanza: revisar la solución implementada por Cristian y confirmar si los cambios están correctos | Owner: Valeria (cliente)
...
#### Mi Propósito
- [ ] 🆕 **[UCSP — Mi Propósito]** Ángel: 23Abril — reunión con César mañana 24 de abril a las 9 am | Owner: Ángelito
...
- [ ] 🆕 **[UCSP — Admisión Pregrado]** Pablo: 23Abril — actualizar esquema del Agente IA de Admisión para automatizar y documentar todo en HubSpot sin conexiones SGA ni Nexus | Owner: Pablo

#### Experiencia del Estudiante
- [ ] 🆕 **[UCSP — Experiencia del Estudiante]** Ángel: 23Abril — asistir a reunión el lunes al mediodía | Owner: Ángelito
...
- [ ] 🆕 **[UCSP — HubSpot SpotLight]** Pablo + Cristian: identificar qué formulario está asociado al dominio "cdpn.io" que está generando conversiones no reconocidas — solicitud urgente de Claudia Tapia (23/04) | Owner: Pablo + Cristian
...
- [ ] 🆕 **[UCSP — Nuevas Carreras]** Enrique: 23Abril — revisar Gantt de nuevas carreras subido ayer | Owner: Enrique
...
- [ ] 🆕 **[UPSJB]** Estuardo: consultar al equipo de Atom sobre gestión de mensajes duplicados cuando el número está conectado simultáneamente en HubSpot y Atom | Owner: Estuardo (cliente)
- [ ] 🆕 **[UPSJB]** Estuardo: gestionar creación de landings diferenciadas por semestre (26.2 y 27.1) para Lima y filiales — sin nofollow para no afectar posicionamiento | Owner: Estuardo (cliente)
- [ ] 🆕 **[UPSJB]** Pablo: revisar viabilidad de renombrar landings por semestre y coordinar con Leslie y agencia SEO para preservar posicionamiento SEO | Owner: Pablo
- [ ] 🆕 **[UPSJB]** Equipo: definir estrategia de pauta diferenciada por carrera y sede — Lima separado de Ica/Chincha, presupuesto segmentado | Owner: Equipo
- [ ] 🆕 **[UPSJB]** Pablo + Enrique + Estuardo: programar reunión de planeamiento macro para cerrar estrategia general antes de bajar a micro por sede/carrera | Owner: Pablo + Enrique
- [ ] 🆕 **[UPSJB]** Enrique + Pablo: 23Abril — realizar ejercicio de planeamiento macro con presupuesto aprobado y TC ajustadas compartidas por Estuardo — luego bajar al micro para cotejo | Owner: Enrique + Pablo
...
- [ ] 🆕 **[AGÉNTICA]** Ángel + Marcos: 23Abril — armar listas de públicos para agentes IA (las que sea posible) | Owner: Ángelito + Marcos
...
- [x] **[WV PE]** Cristian + Marcos: pagos duplicados TXT Débito BCP — RESUELTO: no se encontraron duplicados en ambas quincenas. Se agregaron validaciones en WFs para evitar duplicación futura | Owner: Cristian
